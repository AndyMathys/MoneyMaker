...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { address: @partner.address, bankaccount: @partner.bankaccount, email: @partner.email, name: @partner.name, vat: @partner.vat }
    end
  ...
  test "should update partner" do
    put :update, id: @partner, partner: { address: @partner.address, bankaccount: @partner.bankaccount, email: @partner.email, name: @partner.name, vat: @partner.vat }
    assert_redirected_to partner_path(assigns(:partner))
  end
